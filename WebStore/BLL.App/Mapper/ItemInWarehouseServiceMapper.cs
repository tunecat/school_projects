...
{
    public class ItemInWarehouseServiceMapper: BaseBLLMapper<DAL.App.DTO.ItemInWarehouse, BLL.App.DTO.ItemInWarehouse>, IItemInWarehouseServiceMapper
    {
        public ItemInWarehouseServiceMapper()
        {
